...
import com.example.collegeappandchatbot.Adapter.AlumniAdapter;
...
public class Alumni extends AppCompatActivity {
    ...
    AlumniAdapter categoryAdapter;
    //SessionManager sessionManager;
    BottomNavigationView bottomNavigationView;
    List<alumniresponse> categorylist = new ArrayList<>();
...
//        });
    ...
    private void loadJSONCategory() {
        ...
        Call<alumnilist> call = api.getalalumni();

        call.enqueue(new Callback<alumnilist>() {
            @Override
            public void onResponse(Call<alumnilist> call, Response<alumnilist> response) {
                if (response.isSuccessful()) {
                    List<alumniresponse> categoryItems = response.body().getCategorylist();
                    ...
                    if (categoryItems != null && !categoryItems.isEmpty()) {
                        ...
                        categoryAdapter = new AlumniAdapter(getApplicationContext(), categorylist);
                        RecyclerView.LayoutManager mLayoutManager = new GridLayoutManager(Alumni.this, 1);
    ...
    private void handleResponseError(Response<alumnilist> response) {
