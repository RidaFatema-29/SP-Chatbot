...
public class EventAdapter extends RecyclerView.Adapter<EventAdapter.ViewHolder>{
    ...
    public EventAdapter(Context mContext, List<DeveventResponse> categoryModels) {
    ...
    @Override
    public void onBindViewHolder(EventAdapter.ViewHolder holder, final int i) {
        ...
        holder.idadd.setText("Venue - "+categoryModel.getDepartment_name());
