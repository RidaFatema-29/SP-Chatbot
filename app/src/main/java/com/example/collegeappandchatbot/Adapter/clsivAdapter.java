...
public class clsivAdapter extends RecyclerView.Adapter<clsivAdapter.ViewHolder>{

    private Context mContext;
    List<industrivresponse> categoryModels = new ArrayList<industrivresponse>();

    public clsivAdapter(Context mContext, List<industrivresponse> categoryModels) {
    ...
    @NonNull
    @Override
    public clsivAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.industrial_row, viewGroup, false);
        return new clsivAdapter.ViewHolder(view);
    }



    @Override
    public void onBindViewHolder(clsivAdapter.ViewHolder holder, final int i) {
